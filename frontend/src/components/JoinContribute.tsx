    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      <div style={{ background: "#1a1a2e", borderRadius: 16, padding: 24 }}>
        ...
        <p style={{ color: "#aaa", fontSize: 13, marginBottom: 12 }}>
          Pega el ID que te compartieron
        </p>
        <div style={{ display: "flex", gap: 8 }}>
          <input
            type="number"
            placeholder="ID del círculo"
            value={joinId}
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 8,
              border: "none",
              background: isJoining ? "#666" : "#f0c040",
              color: "#000",
              fontWeight: 600,
              cursor: isJoining || !joinId ? "not-allowed" : "pointer",
              whiteSpace: "nowrap",
            }}
          >
            {isJoining ? "..." : "Unirse"}
      ...
      <div style={{ background: "#1a1a2e", borderRadius: 16, padding: 24 }}>
        ...
        {ids.length === 0 ? (
          <p style={{ color: "#888", fontSize: 14 }}>
            No tienes círculos activos. Crea uno o únete a uno primero.
          </p>
        ) : (
        ...
        {selectedId !== null && (
          <button
            ...
            style={{
              ...
              borderRadius: 8,
              border: "none",
              background: isContributing ? "#666" : "#4caf50",
              color: "#fff",
              fontSize: 16,
              fontWeight: 600,
              cursor: isContributing ? "not-allowed" : "pointer",
              width: "100%",
            }}
          >
            {isContributing ? "Confirmando..." : `Contribuir al círculo #${selectedId.toString()}`}
          </button>
        )}

        {isContributeConfirming && <p style={{ color: "#f0c040", marginTop: 8, fontSize: 13 }}>Contribuyendo...</p>}
        {isContributeSuccess && <p style={{ color: "#4caf50", marginTop:   8, fontSize: 13 }}>Contribución exitosa!</p>}
      </div>
    </div>
  );
}